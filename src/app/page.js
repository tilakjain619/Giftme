  ...
  return (
    <div className="grid justify-center text-center px-3 py-2">
      <div className="min-h-[80vh] flex flex-col justify-center gap-3 md:gap-4">
        ...
        <p className="text-zinc-800 md:text-xl text-pretty">Let your fans support you with thoughtful gifts and turn your passion into a sustainable journey.</p>
        <Link href="#" className="bg-[#ed5a6b] px-7 text-xl lg:text-2xl py-2.5 w-fit mx-auto rounded-full text-white">Start my page</Link>
        <span className="text-zinc-700">It's free, always!</span>
      </div>
      <section className="w-full mt-4 relative overflow-x-hidden">
      <div class="absolute w-full h-full z-10 inset-0 bg-gradient-to-r from-[#f7f7ed] via-transparent to-[#f7f7ed] pointer-events-none"></div>
        <VelocityScroll
